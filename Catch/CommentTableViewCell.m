...
-(void) setUp
{
   ...
   // if (arc4random() % 2 == 0) {
    ...
    //self.attachedImage = nil;
            ...
            UIBezierPath *exclusionPath = [UIBezierPath bezierPathWithRect: CGRectMake([UIScreen mainScreen].bounds.size.width/2, self.textView.frame.size.height/2, [UIScreen mainScreen].bounds.size.width/2, self.attachedImage.frame.size.height)];
